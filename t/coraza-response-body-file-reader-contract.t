...
like($body_filter,
    qr/ngx_http_coraza_append_response_body_file\(ctx, r,\s*chain->buf\) != NGX_OK\s*\)\s*\{.*?ngx_http_coraza_body_filter_finalize\(r, ctx,\s*NGX_HTTP_INTERNAL_SERVER_ERROR\)/s,
